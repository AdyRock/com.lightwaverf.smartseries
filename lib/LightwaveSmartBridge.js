...
module.exports = class LightwaveSmartBridge extends EventEmitter
{
    ...
    async initialise()
    {
        try
        {
            Homey.app.updateLog( "Initialising Bridge", false );
    ...
    async getAccessToken( ignoreReady )
    {
        ...
        {
            this.log( "LW Bridge getAccessToken Error ", err );
        }
    ...
    async registerWEBHooks( featureID, feature, deviceID )
    {
        try
        {
            ...
            const url = "https://webhooks.athom.com/webhook/5cb111d31705c20e3efc87d2";
    ...
    async deleteLWWebhooks()
    {
        try
        {
            Homey.app.updateLog( "Deleting LW WebHooks" )
        ...
        Homey.app.updateLog( 'LW WEBHooks Deleted' );
    }
