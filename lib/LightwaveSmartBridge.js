...
module.exports = class LightwaveSmartBridge
{
    ...
    async waitForBridgeReady()
    {
        ...
        {
            var connectionNumber = this.homey.app.tokenNumber++;
    ...
    async initAccessToken()
    {
        ...
        var access_token = this.homey.settings.get( 'accesstoken' );
        if ( !access_token )
        {
    ...
    async getNewTokens()
    {
        ...
        const bearerid = this.homey.settings.get( 'bearerid' );
        ...
        try
        {
            ...
            this.homey.settings.set( 'accesstoken', access_token );
    ...
    async registerWEBHooks( featureID, feature, deviceID )
    {
        ...
        try
        {
            ...
            this.homey.app.updateLog( "LW Webhook failed" );
        }
        catch ( err )
        {
            if ( result )
