...
//    { id: "LW929", type: "contact", multiGang: false },
...
module.exports = class LightwaveSmartBridge extends EventEmitter
{
    ...
    async registerWEBHooks( featureID, feature, deviceID )
    {
        if (typeof featureID != 'string')
        {
            console.log( "registerWEBHooks", featureID, typeof featureId );
            return "";
        }
        ...
        try
        {
            ...
            //            Homey.app.updateLog( "Registering LW Webhook: " + JSON.stringify( bodyObj, null, 2 ) );
