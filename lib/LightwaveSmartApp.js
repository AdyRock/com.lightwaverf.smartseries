...
class LightwaveSmartApp extends Homey.App
{
    ...
    _onWebhookMessage( args )
    {
        try
        {
            ...
            {
                this.updateLog( "!!! Webhook missing body or triggerEvent or Payload !!!", true );
                return;
            }
            ...
            this.updateLog( "Webhook: " + driverId + " capability: " + capability + " Value: " + args.body.payload.value, true );
            ...
            if ( !foundMatch )
            {
                this.updateLog( "Webhook not matched", true );
            }
        }
        catch ( err )
        {
            this.log( "Webhook Error", err );
            this.updateLog( "Webhook Error: " + err, true );
        }
    }
