...
module.exports = class lwremote extends Homey.Driver {
    ...
    async onInit()
    {
        ...
        {
            Homey.app.updateLog( "lwremote Driver OnInit Error " + err );
        }
    }
    ...
    onPairListDevices( data, callback )
    {
        ...
        Homey.app.getBridge().getDevicesOfType( 'remote' ).then( function( devices )
        {
