...
module.exports = class lwmotion extends Homey.Driver
{
    ...
    async onInit()
    {
        ...
        {
            this.homey.app.updateLog(`lwmotion Driver OnInit Error ${err}`);
        }
    }
    ...
    {
        return this.homey.app.getBridge().getDevicesOfType('motion');
    }
